...
<section class="flex flex-col md:flex-row md:justify-between items-start md:items-center bg-white shadow-sm rounded-xl p-6 mb-8 gap-6">
  <div>
    ...
    <p class="text-xs text-gray-500 mt-1 max-w-sm">
      Absensi tersedia pada pukul 06.30 - 07.00. Pastikan Anda melakukan absen sebelum waktu absensi berakhir.
    </p>
...
@endpush
  ...
  <section class="bg-white shadow-sm rounded-xl p-6 mb-8">
    <h2 class="text-lg font-semibold mb-4">Catatan Kehadiran Guru</h2>
    <ul class="space-y-4">
      @for ($i = 0; $i < 4; $i++)
  ...
  <section class="bg-white shadow-sm rounded-xl p-6">
    ...
    <ul class="space-y-4">
      <li class="flex items-start gap-4">
        ...
        <div>
          <p class="text-sm font-semibold text-gray-800">Ujian Tengah Semester dimulai 10 Mei 2025</p>
          <p class="text-xs text-gray-500 mt-1">Persiapkan diri Anda dengan belajar dari sekarang.</p>
        </div>
      </li>
      <li class="flex items-start gap-4">
        <div class="bg-yellow-100 text-yellow-600 w-10 h-10 flex items-center justify-center rounded-full">
        ...
        <div>
          <p class="text-sm font-semibold text-gray-800">Libur Nasional - 17 Mei 2025</p>
          <p class="text-xs text-gray-500 mt-1">Sekolah akan libur memperingati Hari Kenaikan Isa Almasih.</p>
        </div>
      </li>
    </ul>
  </section>
